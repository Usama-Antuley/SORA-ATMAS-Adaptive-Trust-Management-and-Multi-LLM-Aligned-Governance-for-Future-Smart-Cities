...
do
echo "Shahbaz"
openssl ecparam -name secp192r1 -genkey -noout -out private-key$i.pem > /home/ubuntu/Desktop/Shahbaz_Final_Project/Ada-Framework-Shahbaz1/01-GetStarted/Keys/Keys2/keto$i.key
